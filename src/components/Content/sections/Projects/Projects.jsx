...
import portfolio from "../../../../assets/pointwebapp.png";
import api from "../../../../assets/api.png";
import { FaCss3Alt,FaNode, FaReact, FaGithub } from "react-icons/fa";
...
export default function Projects() {
  ...
  return (
    <section className="projects flex flex-col items-center justify-center py-8 ">
      ...
      <div className="projects-container grid grid-cols-1 w-full sm:w-4/5 align-baseline justify-items-center sm:grid-cols-2 gap-8">
        <div className="project-card relative">
          <img src={portfolio} alt="Loyalty App" className="project-image rounded-md w-full h-auto max-h-96 object-cover" />
          <div className="card-overlay absolute inset-0 bg-black bg-opacity-75 opacity-0 hover:opacity-100 flex flex-col items-center justify-center rounded-md transition-opacity duration-500">
            ...
            <div className="card-technologies flex gap-4 mb-4">
              ...
              <a href="https://tailwindcss.com/" className="social-links text-2xl text-white" target="_blank" rel="noreferrer">
                <SiTailwindcss />
              </a>
            </div>
            <div className="card-buttons flex gap-4">
              ...
              <a href="https://github.com/EdyRodriguez/point-games-web" target="_blank" className="card-button-code bg-gray-700 text-white py-2 px-4 rounded-md flex items-center gap-2 hover:bg-gray-900 transition-colors duration-300">
                <FaGithub />
        ...
        <div className="project-card relative">
          <img src={api} alt="Loyalty App Api" className="project-image rounded-md w-full h-auto max-h-96 object-cover" />
          <div className="card-overlay absolute inset-0 bg-black bg-opacity-75 opacity-0 hover:opacity-100 flex flex-col items-center justify-center rounded-md transition-opacity duration-500">
            <h2 className="text-xl text-white mb-4">{translation.projects.thirdProject.title}</h2>
            <p className="text-white mb-4 px-4">{translation.projects.thirdProject.description}</p>
            <div className="card-technologies flex gap-4 mb-4">
              <h3 className="text-white">{translation.projects.technologies}</h3>
              <a href="https://react.dev/" className="social-links text-2xl text-white" target="_blank" rel="noreferrer">
                <FaNode />
              </a>
              <a href="https://firebase.google.com/" className="social-links text-2xl text-white" target="_blank" rel="noreferrer">
                <IoLogoFirebase />
              </a>
            </div>
            <div className="card-buttons flex gap-4">
              <a href="https://github.com/EdyRodriguez/point-games-api" target="_blank" className="card-button-code bg-gray-700 text-white py-2 px-4 rounded-md flex items-center gap-2 hover:bg-gray-900 transition-colors duration-300">
                <FaGithub />
                {translation.projects.buttons.code}
              </a>
            </div>
